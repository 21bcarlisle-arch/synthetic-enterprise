...
<!-- BLOCK_RELEASE: director_ratification -- evidence gathered; the float->Decimal migration is a director-reserved decision, boundary-reconciliation returned as [ACT] -->
