...
# [SEAT] land-lane-zero was claimed and has not moved for 1.7h
...
What the seat said it was doing: Check HEAD first, and if it is not already there, land `background/delivery_lane.py`, `tests/background/test_delivery_lane.py` and the `_delivery_lane_draw` wiring in `background/supervisor.py`, `back
```

## What is known without diagnosing anything

- Signature: `seat-claim:land-lane-zero` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-25T22:19:14+00:00
...
**Landing:** bf9d30c14 — the delivery lane landed with its tests; 7f11d9c7d carried the draw wiring. background/delivery_lane.py and tests/background/test_delivery_lane.py are tracked and clean at HEAD.
