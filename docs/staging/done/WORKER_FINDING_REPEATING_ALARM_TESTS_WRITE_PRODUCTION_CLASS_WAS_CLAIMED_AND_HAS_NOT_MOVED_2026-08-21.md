...
# [SEAT] tests_write_production_class was claimed and has not moved for 0.8h
...
What the seat said it was doing: sink guard: blast radius then commit
```

## What is known without diagnosing anything

- Signature: `seat-claim:tests_write_production_class` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-21T13:59:12+00:00
