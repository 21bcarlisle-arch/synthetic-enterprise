# Phase T: Time-of-Use Tariff Profitability Differentiation

**Status:** Draft proposal — 4h opt-out gate.
**Proposed by:** Claude Code (Phase P session), 2026-06-29
**Precondition:** Phase P (EV overnight shape) COMPLETE ✓

---

## Context

Phase P gives EV customers an overnight-weighted demand shape (90% periods 1-14, 47-48).
...
to EV customers or retain the flat-tariff margin from their overnight profile. Phase P
makes this question concrete: EV customers' overnight concentration is now accurately
modelled, so the ToU vs flat-rate cross-subsidy analysis can be done with correct shape.

---

## Gate

4h opt-out from proposal time (~18:50 UTC 2026-06-29). Auto-proceed at ~22:50 UTC.
