<!-- SUPERVISOR_DRAW: consumed -->
<!-- CONSUMED 2026-07-29 (archived to done/): every drawable half of this mint is DISCHARGED. DISCOVER+FRAME landed 2026-07-25 (FRAME W1_6_merit_order_reconstruction_FRAME.md + market_research ssp_multiplant_srmc_stack_heat_rates_2026-07-25.md). The BUILD landed 2026-07-28 as maturity-map atom W1_6b_merit_order_reconstruction (engine sim/merit_order_reconstruction.py, commit efad226db, map reconciled 23dd68eef) -- structurally complete, blocked_on director_level_up (R16). Exit criteria: (2) unmoved-baseline invariant MET, (3) R15 mutations MET, (1) reconstructibility PARTIAL 3/5 calm cells (wins 2018/2019/2020 incl. both renewables-heavy cells the live form posted NEGATIVE lift, loses low-carbon 2016/2017). The sole residual -- a DISCOVER for the EU/UK-ETS annual carbon TIME-SERIES (named R10 data gap, ets_price_gbp_per_tonne wired at default 0.0 so a citable series closes 2016/2017 with NO curve-fit) -- is captured in the W1_6b atom's blocked_on note (the authoritative map record) and queued per SELF_INTERRUPT_DISCIPLINE, so archiving this mint strands nothing. The 02:07Z self-drawable flip re-surfaced a BUILD that had ALREADY landed 07-28 = the consumed-not-absorbed treadmill (feedback_execute_selfdrawable_mints_not_rebookkeep); consuming/archiving is the only move off it (R17). NO re-BUILD, NO interim tuning (R12/R13). -->
