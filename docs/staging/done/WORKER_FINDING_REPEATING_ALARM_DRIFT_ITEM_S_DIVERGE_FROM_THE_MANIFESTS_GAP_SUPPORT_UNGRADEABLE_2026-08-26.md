...
```
[RECONCILE] DRIFT — 8 item(s) diverge from the manifests:
    ✗ [gap:support_ungradeable] EP1_clv_three_horizon
...
- Signature: `auto:7f83bd496749a612` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-26T11:49:09+00:00
