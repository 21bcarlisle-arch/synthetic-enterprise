...
# [ACT] 1 minted work item(s) BLOCKED and un-worked for 2.6h (no forward-work commit) -- the machine is resting beside open mints, not working them. Escalate each (unblock / re-scope
...
- First seen in this episode: 2026-09-10T08:08:09+00:00
...
## Instances seen
- `# minted work item(s) blocked and un-worked for #h (no forward-work commit) -- the machine is resting beside open mints,` (first seen 2026-09-10)
