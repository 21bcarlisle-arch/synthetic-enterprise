...
fired **3 times without its state changing**, over **0.6h**. Under the
...
[RECONCILE] DRIFT — 6 item(s) diverge from the manifests:
    ...
    ✗ [gap:stale] W2_11_payment_behaviour_source
...
- Signature: `auto:b93b5262ef03cf50` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-22T03:18:38+00:00
