...
# [SEAT] belief-vs-truth-is-co-calibrated was claimed and has not moved for 2.0h
...
What the seat said it was doing: Make the coupled belief-versus-truth record state what its two sides share. In `tools/couple_value_based_pricing.py`, where each account's `belief_vs_truth` block is written, record that the company's
```

## What is known without diagnosing anything

- Signature: `seat-claim:belief-vs-truth-is-co-calibrated` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-26T04:01:21+00:00
...
**Landing:** HEAD — tools/couple_value_based_pricing.py at HEAD derives co_calibrated, refuses to publish a co-calibrated pair as inference, and states the shared source in its own clause.
