...
# PUBLISH RECOVERED — all 11 publish steps refreshed their artefacts at run 4c4f7dfaa.

**Filed automatically by `background/alarm_repetition.py`, not by a person.** This alarm has
fired **3 times without its state changing**, over **31.3h**. Under the
...
- Signature: `publish_step_ledger` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-20T14:41:47+00:00
