...
<!-- CONSUMED 2026-07-29 (RUNG-7 planner tick): CORRECTION of the 2026-07-29T02:07Z re-flip. That tick flipped this self-drawable to "surface the DISCOVER" -- but the DISCOVER was ALREADY DONE: docs/design/BOARD_SPEC_001_RECONCILIATION.md exists (305 lines, 39 rows tallied 30 MET / 39 PARTIAL / 32 ABSENT / 1 N-A, findings F1-F5 present, format matches BOARD_SPEC_004), committed 2026-07-28 in d7e0ad0f0. The 02:07Z release read this doc's stale STATUS section ("Produce ...RECONCILIATION.md") and ignored both the CLOSED banner below and the published file on disk, re-opening completed work (a false self-drawable that kept the planner re-firing). R1 consumer-verified: the exit criterion is met on disk. Marker flipped self-drawable->blocked and archived to done/ (consumed). No new work; findings F1-F5 remain [ACT] items for the director as originally recorded. -->
