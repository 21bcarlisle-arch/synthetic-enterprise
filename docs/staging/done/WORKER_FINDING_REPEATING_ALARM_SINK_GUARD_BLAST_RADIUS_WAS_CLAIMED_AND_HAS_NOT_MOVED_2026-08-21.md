...
# [SEAT] sink_guard_blast_radius was claimed and has not moved for 0.8h
...
What the seat said it was doing: built, holes proven closed, NOT committed: blast radius unmeasured because the sweep competes with the publisher for the box
```

## What is known without diagnosing anything

- Signature: `seat-claim:sink_guard_blast_radius` — the alarm text with elapsed times, counters, hashes and timestamps
  normalised away, so this is the same CONDITION recurring, not the same string.
- First seen in this episode: 2026-08-21T16:49:44+00:00
