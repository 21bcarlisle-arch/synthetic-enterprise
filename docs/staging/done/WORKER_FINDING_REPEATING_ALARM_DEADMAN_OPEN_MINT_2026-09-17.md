...
# [ACT] 1 minted work item(s) BLOCKED and un-worked for 2.4h (no forward-work commit) -- the machine is resting beside open mints, not working them. Escalate each (unblock / re-scope

**Filed automatically by `background/alarm_repetition.py`, not by a person.** This alarm has
fired **3 times without its state changing**, over **0.4h**. Under the
...
- First seen in this episode: 2026-09-17T04:27:31+00:00
...
## Instances seen
- `# minted work item(s) blocked and un-worked for #h (no forward-work commit) -- the machine is resting beside open mints,` (first seen 2026-09-17)
