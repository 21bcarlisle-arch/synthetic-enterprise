...
# [ACT] 2 SELF-DRAWABLE mint(s) have sat UNDRAWN in in_progress/ for 2.4h with no forward-work commit -- the tick is supposed to DRAW these, so either the draw is wedged or it is res
...
- First seen in this episode: 2026-09-17T04:27:36+00:00
...
## Instances seen
- `# self-drawable mint(s) have sat undrawn in in_progress/ for #h with no forward-work commit -- the tick is supposed to d` (first seen 2026-09-17)
