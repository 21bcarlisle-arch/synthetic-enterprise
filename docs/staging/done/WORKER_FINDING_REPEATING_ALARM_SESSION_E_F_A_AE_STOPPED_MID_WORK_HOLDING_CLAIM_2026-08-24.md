...
- `docs/staging/DIRECTOR_CONSOLE_2026-08-24.md`
...
- Last commit on the tree: `53ceb2008 A year-end treasury that disagreed with the run's own printout: two published balance-sheet figures were reading a running total in the wrong order`
