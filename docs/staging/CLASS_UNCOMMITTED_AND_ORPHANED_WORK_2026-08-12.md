...
**Instances:** 7 · **Class:** `uncommitted_and_orphaned_work` · **Ruling's own count:** ~7 (`DIRECTOR_RULING_FINDING_SEVERITY_AND_INTERLEAVE_2026-08-12`, clause 1, "uncommitted/orphaned work")
...
- `WORKER_FINDING_THE_CLOSE_TIME_CHECK_THAT_CATCHES_THIS_HAS_NO_CALLER_2026-08-13.md` — BLOCKING
...
**7.0 recorded episode-hours** across 1 of the 7 instances; largest single recorded episode **7h**; 1 instance(s) name a published figure in scope.
...
- `WORKER_FINDING_THE_CLOSE_TIME_CHECK_THAT_CATCHES_THIS_HAS_NO_CALLER_2026-08-13.md`
