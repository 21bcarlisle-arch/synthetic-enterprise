...
- `docs/design/simplifications/PB3_book_growth_as_earned_outcome.yaml`
- `docs/design/simplifications/archive/EP1_clv_three_horizon.009.yaml`
- `docs/design/simplifications/archive/EP1_clv_three_horizon.010.yaml`
...
- `tests/company/analytics/test_clv_snapshot_series.py`
- `tests/company/compliance/test_printed_bill_foots_render.py`
- `tests/company/interfaces/test_customer_value_seam.py`
- `tests/design/test_atom_notes_store.py`
- `tests/saas/reporting/test_three_horizon_clv_section.py`
...
- `tests/tools/test_couple_clv.py`
...
- Tool calls this session: 371
- Last commit on the tree: `0dc6e252f FINDING: EP13's map says parked-and-unbuilt while the site publishes it, and the correction cannot land behind EP1`
