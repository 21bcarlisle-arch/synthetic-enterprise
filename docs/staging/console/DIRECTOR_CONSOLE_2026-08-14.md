...
# Director console — verbatim record, 2026-08-14
...
### 2026-08-14T07:04:53.686Z

> Did the published figure move to £1,547,113 without telling me
> first? That was the one condition. Say what moved it and confirm
> the re-baseline is honest.
>
> Then: the 13 rate tables clamping past 2024 — fetch the real
> published rates rather than extrapolating, and mark anything still
> extrapolated as such on the surface that shows it. Same for the
> Low Carbon source. Yes to splitting the test file.
