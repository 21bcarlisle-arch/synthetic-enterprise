...
- `SEAT_FINDING_THE_CHECKOUT_ADVANCE_IS_JUDGED_BY_THE_CHECKOUTS_OWN_CODE_SO_EVERY_RULE_THAT_WOULD_UNWEDGE_IT_IS_INSIDE_THE_PAYLOAD_2026-09-24.md` — BLOCKING
