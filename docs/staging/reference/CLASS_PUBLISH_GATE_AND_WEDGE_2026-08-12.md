...
**Instances:** 78 · **Class:** `publish_gate_and_wedge` · **Source's own count:** ~18 (`DIRECTOR_RULING_FINDING_SEVERITY_AND_INTERLEAVE_2026-08-12`, clause 1, "publish-gate/wedge")
...
**518.9 recorded episode-hours** across 22 of the 78 instances; largest single recorded episode **146h**; 10 instance(s) name a published figure in scope.
