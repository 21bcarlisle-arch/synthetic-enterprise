...
*Last updated: 2026-06-27. 400+ commits. 4,048 tests passing. Codebase: ~40,100 lines across 292+ Python modules.*
...
- 400+ git commits
- 4,048 tests (fast / ~10s; simulation integration ~8 min per run)
