...
*Last updated: 2026-06-27. 400+ commits. 4,025 tests passing. Codebase: ~39,960 lines across 291+ Python modules.*
...
- 400+ git commits
- 4,025 tests (fast / ~10s; simulation integration ~8 min per run)
