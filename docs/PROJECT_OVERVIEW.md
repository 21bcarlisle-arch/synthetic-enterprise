...
*Last updated: 2026-06-27. 400+ commits. 4,068 tests passing. Codebase: ~40,250 lines across 293+ Python modules.*
...
- 400+ git commits
- 4,068 tests (fast / ~10s; simulation integration ~8 min per run)
