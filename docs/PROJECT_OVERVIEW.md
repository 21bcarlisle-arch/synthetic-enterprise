...
*Last updated: 2026-06-27. 400+ commits. 3,887 tests passing. Codebase: ~39,250 lines across 288+ Python modules.*
...
- 400+ git commits
- 3,886 tests (fast / ~10s; simulation integration ~8 min per run)
