...
*Last updated: 2026-06-27. 400+ commits. 3,970 tests passing. Codebase: ~39,760 lines across 291+ Python modules.*
...
- 400+ git commits
- 3,970 tests (fast / ~10s; simulation integration ~8 min per run)
