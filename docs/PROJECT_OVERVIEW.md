...
*Last updated: 2026-06-27. 400+ commits. 4,094 tests passing. Codebase: ~40,400 lines across 294+ Python modules.*
...
- 400+ git commits
- 4,094 tests (fast / ~10s; simulation integration ~8 min per run)
