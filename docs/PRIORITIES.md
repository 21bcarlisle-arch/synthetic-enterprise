...
- **Phase OD: Demand Estimation Observatory** -- company EAC estimation accuracy (Phase 23a log exists but no board section). Closes reporting gap: demand_estimation_log already populated but never surfaced.
