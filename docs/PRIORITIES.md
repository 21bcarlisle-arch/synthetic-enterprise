...
- **Phase OH: Feed-in Tariff (FiT) Levy Observatory** -- UK suppliers pay a FiT levy to Ofgem (administered via Levelisation): fit_ledger.py exists but is not wired. FiT cost is typically 2-4% of electricity supply cost. Wiring it closes the policy cost stack.
