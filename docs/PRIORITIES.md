...
- **Phase OF: GSOP (Guaranteed Standards of Performance) Tracker** -- Ofgem GSOP requires suppliers to pay automatic compensation for missed service standards (meter reads, complaints, connections). gsop.py and gsop_tracker.py exist but are not wired. Board section showing GSOP payment obligations by year.
