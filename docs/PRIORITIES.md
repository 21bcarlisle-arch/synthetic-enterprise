...
- **Phase OC: Licence Health Observatory** -- Ofgem licence conditions require ongoing monitoring (SLC 0-35 compliance); annual board attestation. Closes visible gap in company/regulatory/ unused infrastructure.
