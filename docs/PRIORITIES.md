...
- **Phase OI: Climate Change Levy (CCL) Observatory** -- UK suppliers are liable for CCL on energy supplied to non-domestic customers. ccl_ledger.py exists but is not wired. CCL is a significant cost for I&C customers (electricity rate ~0.775p/kWh 2016-2025).
