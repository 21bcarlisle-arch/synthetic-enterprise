...
- **Phase OG: Renewable Obligation (RO) Obligation Cost Observatory** -- UK suppliers must surrender Renewable Obligation Certificates (ROCs) or pay a buy-out price. roc_ledger.py exists but is not wired. RO cost is typically 15-20% of electricity supply cost.
