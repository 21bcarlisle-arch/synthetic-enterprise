...
- **Phase OE: Smart Meter ROI Observatory** -- smart meter rollout reduces EAC estimation error and bad debt. The simulation has smart meter flags (Phase IW) and EAC estimation log (Phase 23a). A board section can show: HH vs non-HH EAC error, estimated reconciliation saving, and smart meter deployment progress.
