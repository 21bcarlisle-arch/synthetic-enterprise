...
| Visible to the composition dial | this module, over all 249 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **39.4%** (98 of 249).
