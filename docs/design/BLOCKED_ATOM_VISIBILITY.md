...
| Visible to the composition dial | this module, over all 347 atoms | 84 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **35.4%** (123 of 347).
