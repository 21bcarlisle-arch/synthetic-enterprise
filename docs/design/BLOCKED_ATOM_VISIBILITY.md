...
| Visible to the composition dial | this module, over all 245 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **38.4%** (94 of 245).
