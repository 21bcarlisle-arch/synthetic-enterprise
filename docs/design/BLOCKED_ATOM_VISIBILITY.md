...
| Visible to the composition dial | this module, over all 266 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **41.7%** (111 of 266).
