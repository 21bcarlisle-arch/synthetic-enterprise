...
| Visible to the composition dial | this module, over all 315 atoms | 101 parked (21 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **42.5%** (134 of 315).
