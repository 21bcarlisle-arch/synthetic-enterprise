...
| Visible to the composition dial | this module, over all 315 atoms | 78 parked (14 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **38.7%** (122 of 315).
