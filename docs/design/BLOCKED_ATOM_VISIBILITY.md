...
|---|---|---|
| Invisible to the BUILD draw | `supervisor._maturity_map_draw_concurrent` (the real draw) | 88/88 parked atoms not offered — 66 proven excluded BY THE PARK (lifting the park alone makes them drawable), 22 excluded for another reason |
| Visible to the staleness clocks | `tools/map_assertion_provenance.build_rows` (AO11) | 88/88 parked atoms carry a row |
| Visible to the composition dial | this module, over all 278 atoms | 88 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **40.6%** (113 of 278).
