...
| Visible to the composition dial | this module, over all 260 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **41.5%** (108 of 260).
