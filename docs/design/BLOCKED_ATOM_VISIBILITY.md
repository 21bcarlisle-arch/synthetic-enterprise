...
| Visible to the composition dial | this module, over all 246 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **38.6%** (95 of 246).
