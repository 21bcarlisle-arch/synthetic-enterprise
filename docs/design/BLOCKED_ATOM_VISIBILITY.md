...
| Visible to the composition dial | this module, over all 314 atoms | 78 parked (14 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **38.5%** (121 of 314).
