...
| Visible to the composition dial | this module, over all 350 atoms | 84 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **35.1%** (123 of 350).
