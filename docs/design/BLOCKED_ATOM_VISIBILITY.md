...
| Visible to the composition dial | this module, over all 286 atoms | 94 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **39.5%** (113 of 286).
