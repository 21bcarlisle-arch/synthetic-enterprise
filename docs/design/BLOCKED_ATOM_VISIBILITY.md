...
| Visible to the composition dial | this module, over all 348 atoms | 84 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **35.3%** (123 of 348).
