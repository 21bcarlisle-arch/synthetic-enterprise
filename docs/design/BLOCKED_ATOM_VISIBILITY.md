...
|---|---|---|
| Invisible to the BUILD draw | `supervisor._maturity_map_draw_concurrent` (the real draw) | 86/86 parked atoms not offered — 64 proven excluded BY THE PARK (lifting the park alone makes them drawable), 22 excluded for another reason |
| Visible to the staleness clocks | `tools/map_assertion_provenance.build_rows` (AO11) | 86/86 parked atoms carry a row |
| Visible to the composition dial | this module, over all 276 atoms | 86 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **40.9%** (113 of 276).
