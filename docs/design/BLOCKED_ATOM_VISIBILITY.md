...
| Visible to the composition dial | this module, over all 295 atoms | 95 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **40.7%** (120 of 295).
