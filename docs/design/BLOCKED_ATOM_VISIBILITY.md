...
| Visible to the composition dial | this module, over all 324 atoms | 78 parked (14 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **38.0%** (123 of 324).
