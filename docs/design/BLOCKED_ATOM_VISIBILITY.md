...
| Visible to the composition dial | this module, over all 296 atoms | 95 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **40.9%** (121 of 296).
