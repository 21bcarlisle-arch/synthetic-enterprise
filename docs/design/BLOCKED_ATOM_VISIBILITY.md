...
| Visible to the composition dial | this module, over all 256 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **41.0%** (105 of 256).
