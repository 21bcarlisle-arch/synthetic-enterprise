...
| Visible to the composition dial | this module, over all 242 atoms | 82 parked (20 with a gate stated in `block_reason`) |
...
Harness share of the whole map: **37.6%** (91 of 242).
