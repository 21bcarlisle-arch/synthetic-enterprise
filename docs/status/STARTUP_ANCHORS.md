...
| `docs/institutional/knowledge_map.md` | What we know and what we have NOT established, with the gaps named | 2026-09-18 | 0 | UNDATED |
...
|---|---|---|---|
| commits | 10,474 | 10,144 – 10,646 (`git rev-list --count`) | AGREES |
| lines | 960,622 | 925,703 – 977,248 (newlines across every `*.py` in the git index) | AGREES |
| modules | 2,948 | 2,898 – 2,976 (the count of `*.py` in the git index) | AGREES |
