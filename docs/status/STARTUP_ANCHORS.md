...
Generated: 2026-09-21 by `tools/startup_anchor_freshness.py`.
...
|---|---|---|---|---|
| `docs/PROJECT_OVERVIEW.md` | This document | 2026-09-17 | 4 | FRESH |
| `docs/reports/ANNUAL_REPORT.md` | The book's own annual report, regenerated each publish | 2026-09-19 | 2 | UNDATED |
| `docs/market_research/ASSUMPTIONS.md` | Every sourced assumption the world is built on, with its anchor and its gaps | 2026-09-06 | 15 | OLD |
| `docs/status/LATEST.md` | What just happened and what the machine is working on now | 2026-09-19 | 2 | FRESH |
| `docs/status/STARTUP_ANCHORS.md` | The computed age of every anchor on this page, and what each is for | 2026-09-19 | 2 | FRESH |
| `docs/status/SEAT_STRETCH_LOG.md` | Why each stretch of work went the way it did — the corrections, what was stopped short of, the reasoning behind a call | 2026-09-18 | 3 | UNDATED |
| `docs/direction/DIRECTION.yaml` | What the delivery seat is currently steering by, and what it has recorded as wrong | 2026-09-21 | 0 | UNDATED |
| `docs/direction/decisions.jsonl` | The append-only record of decisions taken, oldest to newest | 2026-09-21 | 0 | UNDATED |
| `docs/status/PROJECT_STATE.txt` | Build state — current phase and test count, generated each publish | 2026-09-19 | 2 | FRESH |
| `docs/institutional/knowledge_map.md` | What we know and what we have NOT established, with the gaps named | 2026-09-19 | 2 | UNDATED |
| `docs/operations/MAINTENANCE.md` | The monthly maintenance runbook this machine operates under | 2026-07-06 | 77 | UNDATED |
