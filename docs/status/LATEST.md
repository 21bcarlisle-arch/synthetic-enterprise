...
- Short position buys shortfall at NBP spot/therm; long gets 0.85x credit; 2022 crisis 10x more expensive than 2016
- Fidelity: UK gas shippers must nominate daily to Xoserve (UNC obligations) -- imbalance drove supplier failures 2021-22
...
- Fidelity: CLV:CAC ratio determines whether acquisition spend is justified

**Phase 140 COMPLETE (2026-06-27):** MOA charge management -- 9 new tests (2,278 total).
- company/billing/moa_charges.py: per-meter-point MOA charges (5 types, 2016-2025 indexed)
- Interpolated rates; SMETS2 higher (DCC comms overhead); partial-year pro-rating
- Fidelity: MOA charges are a line item in every supplier P&L but rarely modelled

**Phase 139 COMPLETE (2026-06-27):** REGO procurement and retirement -- 10 new tests (2,269 total).
- company/market/rego_portfolio.py: REGO buy/retire/coverage_check for renewable tariff compliance
- get_rego_price() 2016-2025: 2022 crisis spike to £6.50/MWh
- Fidelity: Ofgem can void "100% renewable" claims if REGO coverage <100%
...
- Fidelity: SLC breach reporting audit trail required for Ofgem inspection

**Phase 136 COMPLETE (2026-06-27):** Renewal pricing engine -- 9 new tests (2,241 total).
- company/billing/renewal_engine.py: 3-option renewal packs (fixed 1yr/2yr/SVT)
- Priced from observable market data (spot feed) + margin target + term premium
- Fidelity: renewal offers are the primary retention tool for fixed-term customers

**Phase 135 COMPLETE (2026-06-27):** Customer credit scoring -- 9 new tests (2,232 total).
- company/crm/credit_scoring.py: PRIME/STANDARD/SUBPRIME/HIGH_RISK tiers from observable signals
- assess_credit() scores on DD status, missed payments, arrears, account age, bad debt
- Fidelity: deposit and PPM decisions gate new customer onboarding risk
