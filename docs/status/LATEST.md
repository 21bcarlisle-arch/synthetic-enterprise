...
Last updated: 2026-07-02T02:20:11Z

## Current Status
**Phase NE complete** -- 14,636 tests

## Last Run
See docs/reports/run_output_latest.json.
Net position: £1,461,253 (git f23d9a7a, 2026-07-02)
...
- Retention: 27 offers, 26/27 retained | 5 no-offer churns | 6 total churned accounts