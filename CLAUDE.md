...
**Phase AQ COMPLETE (2026-06-30):** Board Risk Summary -- 12 new tests (5,366 total). annual_report.py: _section_board_risk_summary() synthesises 6 RAG indicators (concentration/gas-ROC/churn-miss/demand-error/basis-risk/net-margin%). Board: 4 REDs (gas ROC=-0.7x, churn miss 67%, demand 3.3%/15.6% peak, 2025+32.8% basis). Wired second in generate_annual_report.
