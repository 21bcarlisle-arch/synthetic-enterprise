...
## Current state
**Phase BB COMPLETE (2026-06-30):** Risk Committee Decision Ledger -- 15 new tests (5,519 total). company/risk/risk_committee_ledger.py: InterventionTrigger/InterventionOutcome enums; CommitteeSession (frozen; var_ratio/outcome/treasury_delta_gbp; EFFECTIVE/NEUTRAL/COUNTERPRODUCTIVE/PENDING by ±£1k threshold); RiskCommitteeDecisionLedger (sessions_for_year; sessions_by_trigger; effective_interventions; intervention_effectiveness_rate; most_active_trigger; busiest_year; peak_stressed_var_gbp; governance_summary). Connects to var_monitor (Ph282), hedge_effectiveness (Ph319), financial_resilience (Ph318).
