...
**Phase U COMPLETE (2026-06-29):** EV Cross-Subsidy Register -- 16 new tests (4,974 total). company/pricing/ev_cross_subsidy.py (new): CrossSubsidyRecord (frozen; flat_margin_gbp/tou_margin_gbp/cross_subsidy_gbp/is_at_risk/years_with_ev); CrossSubsidyRegister (record using Phase T OVERNIGHT_HEAVY shape/top_n_by_cross_subsidy/at_risk_if_tou_launched threshold/total_cross_subsidy_gbp/average_cross_subsidy_gbp/portfolio_summary). Key finding: cross_subsidy proportional to annual_kwh (EV at 8,000 kWh = 4x cross-subsidy vs 2,000 kWh); crisis year cross-subsidy still present but both margins compressed; top_account_id in portfolio_summary. Closes gap: Phase T gave theoretical economics; Phase U gives operational per-customer register for product strategy.
