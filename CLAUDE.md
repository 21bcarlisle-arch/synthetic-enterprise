...
**Phase AP COMPLETE (2026-06-30):** Segment Capital Efficiency -- 12 new tests (5,354 total). annual_report.py: _section_segment_capital_efficiency(): lifetime ROC by segment; CAPITAL DESTROYER/<0x flag; gas finding (I&C gas -0.7x, resi gas -0.9x; electricity cross-subsidises gas). Board: gas legs destroy capital; dual-fuel pricing reform needed.
**Phase AO COMPLETE (2026-06-30):** Demand Estimation Error Trend -- 12 new tests (5,342 total). annual_report.py: _section_company_divergence() extended with demand_error_by_year; year-by-year mean/max EAC error; HIGH/MODERATE/Low signals; trend note (0.07%→3.26%/15.56% in 2024); smart meter action note.
**Phase AN COMPLETE (2026-06-30):** Portfolio Concentration Risk -- 12 new tests (5,330 total). annual_report.py: _section_portfolio_concentration_risk(): HHI on margin shares; segment breakdown (I&C 98.7%/resi 0.9%/SME 0.5%); top-5 with churn-weighted margin-at-risk; warning >95% I&C. HHI=2,249 MODERATE.
