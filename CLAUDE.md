...
**Phase AI COMPLETE (2026-06-30):** EAC Drift Snapshot -- 10 new tests (5,266 total). saas/reporting/annual_report.py: _section_eac_drift_snapshot() groups demand_estimation_log by customer, computes first→last EAC drift, classifies as significant/moderate/stable, infers likely cause (EV/ASHP/solar/efficiency), shows notable-drift table + portfolio trend. Connects Phase 23a/25a (demand estimation log). Epistemic: company billing data only.
**Phase AH COMPLETE (2026-06-30):** Board Intelligence Pack -- 12 new tests (5,256 total). saas/reporting/annual_report.py: _section_portfolio_intelligence_pack() synthesises retention coverage rate/acceptance rate/margin protected; flexibility enrollment CAGR/revenue-per-enrolled; churn peak year/net book movement; 4 board recommendations. Wired after _section_flexibility_revenue. Connects retention_log, no_offer_churn_log, company_event_log, flexibility_revenue_summary.
