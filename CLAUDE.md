...
**Phase AF COMPLETE (2026-06-30):** DSR/Flexibility Revenue Integration -- 15 new tests (5,232 total). company/market/flexibility_revenue_book.py (new): FlexibilityRevenueRecord (frozen); FlexibilityRevenueBook (compute_year queries HouseholdDemandRegister.dynamic_assets; CM revenue 2016+ £75/kW/yr; DFS revenue 2022+ £4.5/MWh×20 events/yr; flexibility_summary). Wired into run_phase2b.py and annual_report.py (flexibility_revenue_gbp per year). EV: £555/yr CM + £666/yr DFS; EV+battery: £2,046/yr. Connects Phase AA, N, Q.
