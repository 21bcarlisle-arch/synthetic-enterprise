...
**Phase U COMPLETE (2026-06-29):** EV Cross-Subsidy Register -- 16 new tests (4,974 total). company/pricing/ev_cross_subsidy.py: CrossSubsidyRecord (flat/tou margin, cross_subsidy, at-risk flag); CrossSubsidyRegister (top_n_by_cross_subsidy/at_risk_if_tou_launched/portfolio_summary). Connects Phase T.
