...
**Phase AH COMPLETE (2026-06-30):** Board Intelligence Pack -- 12 new tests (5,256 total). annual_report.py: _section_portfolio_intelligence_pack() synthesises retention coverage/acceptance/margin; flex CAGR/revenue-per-enrolled; churn peak year/net book movement; 4 board recs.
**Phase AG COMPLETE (2026-06-30):** Annual Report Flexibility Revenue Section -- 12 new tests (5,244 total). saas/reporting/annual_report.py: _section_flexibility_revenue() renders year-by-year CM vs DFS revenue table; pre-DFS years (pre-2022) label DFS column as pre-DFS; portfolio total summary with CM/DFS split; enrolled customer-years count; DFS launch note (NESO Oct 2022). Wired into generate_annual_report after _section_profitability_uplift. Makes Phase AF flex revenue data visible in report output. Connects Phase AF (FlexibilityRevenueBook), Phase AA (FlexibilityPotentialBook).
