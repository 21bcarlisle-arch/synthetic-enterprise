...
**Phase AK COMPLETE (2026-06-30):** Churn Root Cause Attribution -- 14 new tests (5,294 total). annual_report.py: _section_churn_root_cause() cross-references customer_events/dynamic_pricing_log/churn_basis_risk/per_customer_lifetime; rate shock + rate-vs-SVT + company vs sim per departure; blind misses/warned/crisis/overpriced summary. 6 churns: £39,706 lost; 3 blind misses.
**Phase AJ COMPLETE (2026-06-30):** CRM Risk Triage Section -- 14 new tests (5,280 total). annual_report.py: _section_crm_intelligence() uses churn_basis_risk (latest renewal per customer) + per_customer_lifetime; CRITICAL/HIGH/MEDIUM/LOW bands; rate-vs-SVT flag; lifetime margin at risk; company blind spot count. Connects Phase AD (churn bands), Phase AC (repricing), Phase 11b.
