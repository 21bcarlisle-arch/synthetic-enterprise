...
class _Advance:
    ...
    def __init__(self, ff_results, blocking, twins):
...
def test_a_modified_path_beside_a_twin_removes_nothing():
    """A tracked file this tree has EDITED is a lane's uncommitted work. It cannot be hashed away,
    the fast-forward cannot succeed while it stands, and so nothing may be removed for it.
