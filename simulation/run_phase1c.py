"""Phase 1c end-to-end run: four synthetic PC1 customers, priced and settled
against real 2016 market data using a synthetic forward curve, rolled up into a portfolio P&L for the
...
def build_priced_customers() -> list[dict]:
    ...
    for customer in CUSTOMERS:
        ...
        forward_price = generate_forward_price(acquisition_date, pricing_window_records)
