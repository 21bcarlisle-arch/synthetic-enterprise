...
UNFITTED_YEARS: dict[int, str] = {
    ...
    2022: (
        ...
        "a required `market_switching_multiplier`, and recomputed from the committed capture's own "
        "rows under that hazard its SVT floor is 2.34% against a published 4.30% ceiling -- BELOW "
        "the target, not 7.8pp above it. THE UNREACHABILITY ARGUMENT THEREFORE INVERTED: 2022 is "
